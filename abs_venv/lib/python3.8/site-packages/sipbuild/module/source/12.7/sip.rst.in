...
.. py:class:: array
    ...
    :py:class:`~@SIP_MODULE_FQ_NAME@.array` object can be created from a
    :py:class:`~@SIP_MODULE_FQ_NAME@.voidptr` object by calling
    :py:func:`~@SIP_MODULE_FQ_NAME@.voidptr.asarray`.  This allows the
