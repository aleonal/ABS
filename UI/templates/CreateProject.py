...
class CreateProject(object):
    def setupUi(self, Widget):
        ...
        self.create_button.clicked.connect(self.CausationExtractor)
...
"it will be created"))
    ...
    def CausationExtractor(self, Widget):
        ...
        ui = Causation_Extractor.Causation_Extractor()
        Widget = ui.setupUi(self.Widget)
        Widget.show()
        self.Widget.hide()
