<<<<<<< HEAD:UI/templates/Create Project.py
# -*- coding: utf-8 -*-
...
import CausationExtractorWidget
from PyQt5 import QtCore, QtGui, QtWidgets
...
class CreateProject(object):
    ...
    def retranslateUi(self, Widget):
        _translate = QtCore.QCoreApplication.translate
        Widget.setWindowTitle(_translate("Create Project", "Create Project"))
        self.root_text.setText(_translate("Widget", "Root Directory:\n"
"\n"
"*If directory does not exist,\n"
"it will be created"))
    ...
    def CausationExtractor(self, Widget):
        Widget = QtWidgets.QWidget()
        ui = CausationExtractorWidget.CausationExtractorWidget()
        ui.setupUi(Widget)
        Widget.show()
        #self.Widget.hide()
...
if __name__ == "__main__":
    ...
    Widget.show()
    sys.exit(app.exec_())
>>>>>>> bcefa669e35dde99f3bc5c8d3a69937493fa5437:UI/templates/CreateProject.py
